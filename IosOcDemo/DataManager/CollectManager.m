...
static CollectManager* _sharedManager = nil;
...
- (id)init{
    ...
    appContext = [[CoreDataManager sharedManager] getManagedObjectContext];
    return self;
}
...
{
    NSEntityDescription *entityDescription = [NSEntityDescription entityForName:entityName inManagedObjectContext:appContext];
